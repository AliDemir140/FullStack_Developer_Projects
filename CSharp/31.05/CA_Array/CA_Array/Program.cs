//Array (dizi) Koleksiyon: ilkel koleksiyon. 

//Aynı tipteki verilerin tek çatı altında toplanması.

//Herhangi bir tip'e bağlı birden fazla değeri bir arada tutulması için array (dizi) kullanırız.
...
//dizilerde eleman sayısı zorunluluğu bulunmaktadır.
...
for(int i=0; i<sayilar.Length; i++)
{
    ...
    {
        adet++;
        Console.WriteLine("Hem ikiye hem de üçe tam bölünen: " + sayilar[i]);
    }
}

Console.WriteLine("İkiye tam bölünenler: "+ikiyeTamBolunenler);
Console.WriteLine("İkiye tam bölünmeyenler: "+ikiyeTamBolunmeyenler);
